...
2. 按 `modules/job-intelligence/MODULE.md` 与 `.useless-linkedin/operations/application-rules.md` 查重、执行 14 项 Knock-out，再做 A–G 分析；需要准备申请时另做 H 申请回答草稿。未知硬条件不得写 PASS；疑似重复不自动合并。
