...
上游：[https://github.com/fky2015/resume-ng-typst](https://github.com/fky2015/resume-ng-typst)

固定 commit：`bc2d5ce0299b4d2fe328bb24a9820caff8a6fc9f`；入口来源：`lib/lib.typ`。
...
原版字体：Noto Serif CJK SC / Noto Serif CJK SC。开放字体从固定清单安装；系统字体使用本机合法安装版本，不再分发。上游未声明的字体保持原生默认设置。
