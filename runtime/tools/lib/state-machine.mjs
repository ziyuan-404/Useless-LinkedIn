...
const allowed = {
  ...
  approved: ['submitting','review-required','needs-verification','expired'],
  submitting: ['submission-unconfirmed','submitted','blocked-login','blocked-captcha','review-required'],
  'submission-unconfirmed': ['submitted','submitting','needs-verification','review-required'],
